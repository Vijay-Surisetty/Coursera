...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            # Enter your code below. Make sure you have correct formatting.
            tree_fig = px.treemap(tree_data, path = ['DestState','Reporting_Airline'],value='Flights',colors='Flights',color_continuous_scale='RdBu',title='Flight Count by airline to destination state')
